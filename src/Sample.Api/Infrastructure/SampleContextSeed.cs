namespace Sample.Api.Infrastructure
{
    ...
    using System;
    using global::Sample.Api.Extensions;
    using Sample.Api;
    ...
    public class SampleContextSeed
    {
        ...
        {
            var log = loggerFactory.CreateLogger("sample seed");

            var context = (SampleContext)applicationBuilder
                .ApplicationServices.GetService(typeof(SampleContext));

            var settings = applicationBuilder
                .ApplicationServices.GetRequiredService<IOptions<SampleSettings>>().Value;
